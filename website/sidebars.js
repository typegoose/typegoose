module.exports = {
  docs: {
    ...
    Decorators: ["api/decorators/prop", "api/decorators/map-prop", "api/decorators/model-options", "api/decorators/hooks", "api/decorators/indexes", "api/decorators/plugins", "api/decorators/query-method"],
