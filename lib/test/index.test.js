...
describe('Typegoose', function () {
    ...
    it('should create a User with connections', function () { return __awaiter(_this, void 0, void 0, function () {
        var car, _a, trabant, zastava, user, foundUser, _b, janitor, manager, _c, foundTrabant, foundZastava, foundUser, createdUser, foundUser, cloneUser, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 11:
                    err_1 = _d.sent();
                    global.console.log('err', err_1);
                    chai_1.expect(err_1).to.have.property('name', 'MongoError');
                    chai_1.expect(err_1).to.have.property('code', 110000);
                    return [3 /*break*/, 12];
