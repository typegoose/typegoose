...
export interface TypegooseModel<
  ...
  /**
   * Creates and saves multiple documents to the database. Shortcut for `Model.create(doc).save()`.
   * The generic parameter "ExtraOmittedKeys" are extra keys ignore in the type for the sake of the creation of this document
  ...
  /**
   * Creates and saves multiple documents to the database. Shortcut for `await docs.forEach(async (doc) => await Model.create(doc).save())`.
   * The generic parameter "ExtraOmittedKeys" are extra keys ignore in the type for the sake of the creation of this document
   * It is useful for excluding getters/setters, which don't strictly need to be specified in the document.
