...
<sub>Please use [Dark-Reader](https://chrome.google.com/webstore/detail/dark-reader/eimadpbcbfnmbkopoojfekhnkhdbieeh) for a dark version of
the site.</sub>

## Quick Overview of Typegoose

Typegoose is a "wrapper" for writing Mongoose models via TypeScript.
...
_Please note that this guide is for Typegoose 7.0+_
