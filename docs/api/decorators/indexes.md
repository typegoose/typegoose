...
| `options`                                                     | [`IndexOptions<T>`](https://mongodb.github.io/node-mongodb-native/5.9/interfaces/CreateIndexesOptions.html) | Overwrite Schema Options, merged with original schema options |
