...
Javascript templating like `${variable}` & Typescript brackets like `Map<T>` need to be escaped via code-blocks, html codes or a backslash.

See [Preparing your site for Docusaurus v3](https://docusaurus.io/blog/preparing-your-site-for-docusaurus-v3#common-mdx-problems) for some more issues and resolutions.
