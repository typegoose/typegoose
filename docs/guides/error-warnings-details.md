...
Error: `Please use mongoose 5.12.9 or higher (Current mongoose: x.x.x) [E001]`

Details:  
Typegoose requires at least mongoose version 5.12.9, because that version changed something that affected typegoose internals
