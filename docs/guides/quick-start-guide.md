...
:::note
This Guide is for Typegoose version ~13.0
:::
...
- TypeScript version `^5.9` is recommended, though older ones may also work
...
- tsconfig option `target` being at least `es6`, recommended is `es2023`
