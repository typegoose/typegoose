...
Error: `Please use mongoose 6.7.0 or higher (Current mongoose: x.x.x) [E001]`

Error Class: `Error`

Details:  
Typegoose requires at least mongoose version `6.7.0`, because that version changed something that affected typegoose internals
