...
Error: `Please use mongoose 6.0.9 or higher (Current mongoose: x.x.x) [E001]`

Details:  
Typegoose requires at least mongoose version `6.0.9`, because that version changed something that affected typegoose internals
